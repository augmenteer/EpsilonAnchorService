...
namespace SharingService.Data
{
    ...
    public interface IAnchorKeyCache
    {
        ...
        Task<string[]> GetAllAnchorKeysAsync();

        Task<string> GetAllAnchorKeysAsStringAsync();
        /// <summary>
        ...
        Task<long> SetAnchorKeyRegistrationAsync(string anchorKey, string objectName);

        Task<bool> DeleteAllAnchorKeysAsync();

        Task<bool> DeleteAnchorKeyAsync(string anchorKey);
    }
}
